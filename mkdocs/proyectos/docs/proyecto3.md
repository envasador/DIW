...
| i) Se ha utilizado y actualizado la guía de estilo. | El diseño realizado es fiel al 100% del diseño del prototipado. (puede contener pequeñas correcciones justificadas) | El diseño realizado es fiel al menos al 75% del diseño del prototipo, justificando los cambios | El diseño realizado es fiel al menos al 75% del diseño del prototipo, sin justificación | El diseño realizado es fiel al al menos al 50% del diseño del prototipo, sin justificación | El diseño realizado no es fiel al diseño del prototipo, sin justificación | No asiste o no es evaluable |
